...
<script type="text/javascript">
	...
	?>,
			...
			updateChartsIntervalLowerLimit = 500, // milliseconds
			updateChartsIntervalUpperLimit = 1000, // milliseconds
	...
	?>,
			...
			trafficMedium: [
				{ name: "Belum Memilih", users: <?php
		$query = mysqli_query($connect, "SELECT * FROM pengguna where status = 0");
		$jml = mysqli_num_rows($query);
		echo $jml;
	?> },
				{ name: "<?php 
			$query = mysqli_query($connect,'SELECT nama FROM kandidat where no_urut=1'); 
	...
	?> },
				{ name: "<?php 
			$query = mysqli_query($connect,'SELECT nama FROM kandidat where no_urut=2'); 
			$nama = mysqli_fetch_assoc($query);
			echo $nama['nama'];
			?>", users: <?php
		clearstatcache();
	...
	?> },
				{ name: "<?php 
			$query = mysqli_query($connect,'SELECT nama FROM kandidat where no_urut=3'); 
			$nama = mysqli_fetch_assoc($query);
			echo $nama['nama'];
			?>", users: <?php
